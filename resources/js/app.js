...
Vue.component('pesq-modal-privacidade', require('./components/PesqModalPrivacidade.vue'));
Vue.component('pesq-modal-fim-pesquisa', require('./components/PesqModalFimPesquisa.vue'));

Vue.component('pesq-perguntas', require('./components/PesqPerguntas.vue'));
Vue.component('pesq-pergunta', require('./components/PesqPergunta.vue'));
