        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div v-for="pergunta in perguntas" :key="pergunta.numero" class="alert" :class="{'alert-success': respostas[pergunta.numero], 'alert-danger': !respostas[pergunta.numero]}">
                            <p>
                            ...
                            <p>
                                Resposta:
                                <span v-if="pergunta.tipo != 4" class="badge p-1" :class="'badge-' + resposta(pergunta.tipo, respostas[pergunta.numero],true)">{{resposta(pergunta.tipo, respostas[pergunta.numero], false)}}</span>
                                <span v-if="pergunta.tipo == 4">{{respostas[pergunta.numero] ? respostas[pergunta.numero].resposta : '-'}}</span>
                            </p>

                            <hr>

                            <a class="btn btn-sm" :class="respostas[pergunta.numero] ? 'btn-success' : 'btn-danger'" href="#carouselPerguntas"  :data-slide-to="pergunta.numero-1">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="#" class="btn btn-success float-right" @click.prevent="envia">
                            Finalizar
...
export default {
    ...
    methods: {
        ...
        conclui: function(envia) {
            if (envia) {
                axios
                    .post('/async/disciplinas/' + this.discId, this.respostas)
